...
const NoResultsOverlay: React.FC<NoResultsOverlayProps> = React.memo(({ content }) => {
    ...
    return (
        <StyledGridOverlay>
            ...
            <Box sx={{ mt: 2 }}>{content || getIntlText('common.message.no_results_found')}</Box>
        </StyledGridOverlay>
    );
});
